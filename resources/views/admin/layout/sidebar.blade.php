    ...
    <li class="{{request()->is('list-marquee-tab*') 
      ...
      <div class="collapse" id="master">
        <ul class="nav flex-column sub-menu">
          <li class="nav-item d-none d-lg-block"><a class="nav-link" href="{{ route('list-marquee-tab') }}">Marquee</a>
          </li>
          <li class="nav-item d-none d-lg-block"><a class="nav-link"
              href="{{ route('list-location-address') }}">Location Address</a></li>
          <li class="nav-item d-none d-lg-block"><a class="nav-link" href="{{ route('list-our-products') }}">List Product Categories</a></li>
        </ul>
      </div>
    </li>
    ...
    <li class="{{request()->is('list-application-form*') 
      ...
      <div class="collapse" id="adminssion">
        <ul class="nav flex-column sub-menu">
          ...
          <li class="nav-item d-none d-lg-block"><a class="nav-link" href="{{ route('list-fesspayment-form') }}">Fees
              Payment</a>
