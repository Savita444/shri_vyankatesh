        ...
        try {
            ...
            if ($request->hasFile('image')) {
                if ($return_data['image']) {
                    if (file_exists_view(Config::get('DocumentConstant.ABOUTUS_DELETE') . $return_data['image'])) {
                        removeImage(Config::get('DocumentConstant.ABOUTUS_DELETE') . $return_data['image']);
                    }
                ...
                $aboutus_data = AboutUs::find($return_data['last_insert_id']);
