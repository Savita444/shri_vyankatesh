...
class AboutUsController extends Controller
{
    ...
    public function index()
    {
        try {
            ...
            return view('admin.pages.home.aboutus.list-aboutus', compact('incidenttype_data'));
        } catch (\Exception $e) {
            return $e;
        }
    }
    ...
    public function edit(Request $request)
    {
        ...
        return view('admin.pages.home.aboutus.edit-aboutus', compact('incidenttype_data'));
    ...
    public function update(Request $request)
{
    ...
    $rules = [
        'service_name' => ['required', 'max:255','regex:/^[a-zA-Z\s]+$/u', Rule::unique('aboutus', 'service_name')->ignore($id, 'id')],
    ];
    ...
    public function show(Request $request)
    {
        try {
            ...
            return view('admin.pages.home.aboutus.show-aboutus', compact('incidenttype_data'));
        } catch (\Exception $e) {
            return $e;
        }
    }
